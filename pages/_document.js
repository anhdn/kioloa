  ...
  render () {
    return (
      <html {...this.helmetHtmlAttrComponents}>
        ...
        <script src='./static/eventalk/js/jquery.min.js' />
        <script src='./static/eventalk/js/jquery-migrate-3.0.1.min.js' />
        <script src='./static/eventalk/js/popper.min.js' />
        <script src='./static/eventalk/js/bootstrap.min.js' />
        <script src='./static/eventalk/js/jquery.easing.1.3.js' />
        <script src='./static/eventalk/js/jquery.waypoints.min.js' />
        <script src='./static/eventalk/js/jquery.stellar.min.js' />
        <script src='./static/eventalk/js/owl.carousel.min.js' />
        <script src='./static/eventalk/js/jquery.magnific-popup.min.js' />
        <script src='./static/eventalk/js/aos.js' />
        <script src='./static/eventalk/js/jquery.animateNumber.min.js' />
        <script src='./static/eventalk/js/bootstrap-datepicker.js' />
        <script src='./static/eventalk/js/jquery.timepicker.min.js' />
        <script src='./static/eventalk/js/scrollax.min.js' />
        <script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false' />
        <script src='./static/eventalk/js/google-map.js' />
        <script src='./static/eventalk/js/main.js' />
      </html>
    )
  }
}
